        ...
        <div class="left_content">
          <div class="single_page">
            ...
            <div class="single_page_content"> <img class="img-center" src="images/single_post_img.jpg" alt="">
              ...
              <h3><a class="page-link" href=keywords.php?cat=<?php echo $categoryID;?>&news=<?php echo $newsItem;?>&keywords=<?php echo $newsKeyword?>>Keywords:&nbsp;&nbsp;<?php echo $newsKeyword; ?></a></h3>
            </div>
            <?php } ?>
                              ...
                              if(!empty($newsDetailsStockResult))
                              {
                                ...
                                if(!empty($newsStockArray))
                                {
                                  foreach($newsStockArray as $newsStockInfo) {
                                    ...
                                    echo '  <div class="media-body"> <a href="generic.php?cat='.$categoryID.'&news='.$newsID.'" class="catg_title">'.$newsTitle.'</a> </div>';
                                    echo '</div>';
                                    echo '</li>';
                                  }    
                                }
              ...
              <nav aria-label="Page navigation">
                <ul class="pagination justify-content-center">
                  <?php if($currentPage != $firstPage) { ?>
                    <li class="page-item">
                      <a class="page-link" href="?page=<?php echo $firstPage ?>&cat=<?php echo $categoryID?>" tabindex="-1" aria-label="Previous">
                        <span aria-hidden="true">First</span>			
                      </a>
                    </li>
                  <?php } ?>
                  <?php if($currentPage >= 2) { ?>
                        <li class="page-item"><a class="page-link" href="?page=<?php echo $previousPage ?>&cat=<?php echo $categoryID?>"><?php echo $previousPage ?></a></li>
                  <?php } ?>
                      <li class="page-item active"><a class="page-link" href="?page=<?php echo $currentPage ?>&cat=<?php echo $categoryID?>"><?php echo $currentPage ?></a></li>
                  <?php if($currentPage != $lastPage) { ?>
                      <li class="page-item"><a class="page-link" href="?page=<?php echo $nextPage ?>&cat=<?php echo $categoryID?>"><?php echo $nextPage ?></a></li>
                       <li class="page-item">
                          <a class="page-link" href="?page=<?php echo $lastPage ?>&cat=<?php echo $categoryID?>" aria-label="Next">
            ...
            <?php } else {?><script>location.href="404.php"<?php } ?>
          </div>
        </div>
      </div>
  </section>
